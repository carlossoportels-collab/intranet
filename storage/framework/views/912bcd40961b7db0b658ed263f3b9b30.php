...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses(['dark' => ($appearance ?? 'system') == 'dark']); ?>">
    <head>
        ...
        <title inertia><?php echo e(config('app.name', 'Intranet')); ?></title>
...
</html><?php /**PATH C:\Users\Compumar\Documents\intranet2026\intranet.backup\resources\views/app.blade.php ENDPATH**/ ?>