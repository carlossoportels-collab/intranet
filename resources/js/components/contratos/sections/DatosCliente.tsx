...
import { User, Phone, Mail, MapPin, Briefcase, Building, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-400 truncate max-w-[200px]">{lead.nombre_completo}</span>
                </div>
                {isExpanded ? (
