...
import { User, CreditCard, Globe, Calendar, MapPin, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-medium text-gray-900">Datos Personales del Cliente</h3>
                </div>
                {isExpanded ? (
