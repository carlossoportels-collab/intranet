...
import Pagination from '@/components/ui/Pagination'; // 👈 Importamos el Pagination global
...
const ListaVehiculosConAbonos: React.FC<ListaVehiculosConAbonosProps> = ({ vehiculos }) => {
    ...
    return (
        <div className="bg-white border-t border-slate-200">
            {/* Header con paginación - actualizado a colores SAT */}
            ...
            {/* Paginación con el componente global */}
            {totalPages > 1 && (
